...
SCHEME = """<scheme>
    ...
    <description>Get data from Automatic.</description>
    ...
    <endpoint>
        <args>
            <arg name="client_id">
                ...
                <description>This is the client ID that Automatic has assigned to you.
            ...
            <arg name="client_secret">
                ...
                <description>Your Automatic Client Secret.</description>
            </arg>
